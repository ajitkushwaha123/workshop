...
const painPoints = [
  ...
  },
  {
    ...
    description: "Running discounts blindly and wasting money without results.",
  ...
  },
  {
    ...
    description: "A huge chunk of every order goes straight to aggregators.",
    image: "/assets/pain-points/high-commission.png",
  },
  {
    title: "5. Low Profits",
    description: "Orders are coming in, but your earnings barely grow.",
    image: "/assets/pain-points/low-payout.png",
  },
  {
    title: "6. Weak Menu Design",
    description: "Customers visit your menu but leave without ordering.",
      ...
      <div className="relative z-10 p-7 pt-2 flex flex-col flex-grow">
        <div className="flex items-start justify-between gap-4 flex-grow">
          <div className="w-full">
            <h3 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white group-hover:text-red-500 transition-colors">
              {title}
            </h3>
      ...
      <div className="container relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        >
          <Title
            ...
            description="Do any of these sound like exactly your problem? You are not alone."
          />
        </motion.div>
